...
Create or replace view pav as (
	select c.nom, c.prenom, v.designation as voiture, c.datecours, c.heurecours
	from candidat c, voiture v, cours c
	where c.idcandidat = c.idcandidat1
	and v.idvoiture = v.idvoiture
);
